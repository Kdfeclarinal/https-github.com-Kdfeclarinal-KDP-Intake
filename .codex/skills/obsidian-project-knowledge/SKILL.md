...
When this skill is used for project knowledge:

- Read the relevant existing note before modifying it.
- Prefer updating an existing note over creating a duplicate.
- Preserve unrelated existing content.
- Write only durable, verified project knowledge.
- Appropriate updates include:
  ...
  - meaningful current-state changes
- Do not store:
  - routine commands
...
- Code and tests are the authority for implementation behavior when
  verifying a claim before writing it as project knowledge.