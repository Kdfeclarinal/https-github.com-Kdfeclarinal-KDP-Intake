-- Follow-up terminal Admin Review finalization repair: preserve the enum-typed\n-- status fix and make employee-update Basecamp reference creation compatible\n-- with the existing partial unique indexes.
